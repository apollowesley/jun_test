package com.jfire.codejson.util;

import java.lang.reflect.Field;
import java.lang.reflect.Method;
import com.jfire.baseutil.reflect.ReflectUtil;
import com.jfire.codejson.annotation.JsonRename;
import com.jfire.codejson.strategy.Strategy;
...
public class NameTool
{
    public static String getNameFromMethod(Method method, Strategy strategy)
    {
        ...
        else
        {
            ...
            if (strategy != null && strategy.containsRename(method.getDeclaringClass().getName() + '.' + fieldName))
            {
