...
import com.jfire.codejson.function.impl.read.ObjectReader;
import com.jfire.codejson.function.impl.read.array.BooleanArrayReader;
import com.jfire.codejson.function.impl.read.array.ByteArrayReader;
import com.jfire.codejson.function.impl.read.array.CharArrayReader;
import com.jfire.codejson.function.impl.read.array.DoubleArrayReader;
import com.jfire.codejson.function.impl.read.array.FloatArrayReader;
import com.jfire.codejson.function.impl.read.array.IntArrayReader;
import com.jfire.codejson.function.impl.read.array.LongArrayReader;
import com.jfire.codejson.function.impl.read.array.ShortArrayReader;
import com.jfire.codejson.function.impl.read.array.StringArrayReader;
import com.jfire.codejson.function.impl.read.wrapper.BooleanReader;
import com.jfire.codejson.function.impl.read.wrapper.ByteReader;
import com.jfire.codejson.function.impl.read.wrapper.CharacterReader;
import com.jfire.codejson.function.impl.read.wrapper.DoubleReader;
import com.jfire.codejson.function.impl.read.wrapper.FloatReader;
import com.jfire.codejson.function.impl.read.wrapper.IntegerReader;
import com.jfire.codejson.function.impl.read.wrapper.LongReader;
import com.jfire.codejson.function.impl.read.wrapper.ShortReader;
...
public class ReaderContext
{
    ...
    static
    {
        ...
        classPool.importPackage("com.jfire.codejson.stringpattern");
    ...
    private static Class<?> createReader(Type type, ReadStrategy strategy)
    {
        ...
        if (type instanceof Class)
        {
            ...
            else
            {
                ...
                for (Method each : ReflectUtil.listSetMethod(tmp))
                {
        ...
        else if (type instanceof ParameterizedType)
        {
            ...
            return buildClass(body, targetClass);
        }
        else if (type instanceof GenericArrayType)
        {
            ...
            return buildClass(body, (Class<?>) root);
        }
