...
* 微信预支付返回结果类
* @author bod
* @date 2017年1月7日 下午5:38:51 
*
 */
public class WxReturnPrepayVo implements Serializable{
	/**
	 * 
	 */
	...
	private String prepay_id;//预支付交易会话标识 Y
	...
	public String toString() {
		return "WxReturnPrepayVo [return_code=" + return_code + ", return_msg=" + return_msg + ", appid=" + appid
