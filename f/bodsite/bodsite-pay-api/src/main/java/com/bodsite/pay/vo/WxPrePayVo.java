 ...
 * 
* 微信预支付实体类
* api:https://pay.weixin.qq.com/wiki/doc/api/jsapi.php?chapter=9_1
* @author bod
* @date 2017年1月4日 上午10:37:52 
*
 */
public class WxPrePayVo implements Serializable{
	...
	private String total_fee;//标价金额 Y
	private String notify_url;//通知地址-回调地址 Y
