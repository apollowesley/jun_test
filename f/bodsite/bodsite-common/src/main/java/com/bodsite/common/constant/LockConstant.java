package com.bodsite.common.constant;

public class LockConstant {
	public static final long DEFALUT_OVER_TIME = 20000;// 默认连接超时时间
	public static final int RETRY_GET_LOCK_COUNT = 200;// 重试次数 默认200次
	...
	public final static String ZOOKEEPER_LOCK_PATH = "/bodsiteLock";// 最好先创建永久路径
	public final static String ZOOKEEPER_HOST = "127.0.0.1:2181";

	public static final String LOCK_NAME_PREFIX = "BODSITE_";// 默认锁前缀
