package com.bodsite.common.lock.aspect;
...
import com.bodsite.common.exception.CommonException;
import com.bodsite.common.lock.Lock;
import com.bodsite.common.lock.redis.RedisDistributedLock;
import com.bodsite.common.lock.zk.ZkDistributedLock;
...
public class LockAspect {
	...
	@Around("@annotation(com.bodsite.common.lock.annotation.Lock)")
	public Object around(ProceedingJoinPoint pjp) throws Throwable {
		MethodSignature methodSignature = (MethodSignature) pjp.getSignature();
		Method method = methodSignature.getMethod();
		com.bodsite.common.lock.annotation.Lock locka = method
				.getAnnotation(com.bodsite.common.lock.annotation.Lock.class);
