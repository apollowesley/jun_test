...
<div class="navbar navbar-inverse">
		  <div class="navbar-inner">
		   <div class="container-fluid">
			  <a class="brand" href="${ctx}/index/home"><small><i class="icon-leaf"></i> 后台管理系统</small> </a>
			  
			  <ul class="nav ace-nav pull-right">
					<li class="grey"  style="width: 60px;">
					...
					<li class="purple" style="width: 60px;">
						<a href="javascript:alert('预留功能,待开发');" class="dropdown-toggle" data-toggle="dropdown">
						...
						<ul class="pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-closer">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<div class="clearfix">
										<span class="pull-left"><i class="icon-comment btn btn-pink"></i> 新消息</span>
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<i class="icon-user btn btn-primary"></i> 测试消息
								</a>
							</li>
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<div class="clearfix">
										<span class="pull-left"><i class="icon-shopping-cart btn btn-success"></i> 新订单</span>
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<div class="clearfix">
										<span class="pull-left"><i class="icon-twitter btn btn-info"></i> 等待消息</span>
					...
					<li class="green"  style="width: 60px;">
						<a href="javascript:alert('预留功能,待开发');" class="dropdown-toggle" data-toggle="dropdown">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Alex's Avatar" class="msg-photo" src="<c:url value="/resources/images/avatar.png"/>" />
									<span class="msg-body">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Susan's Avatar" class="msg-photo" src="<c:url value="/resources/images/avatar3.png"/>" />
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Bob's Avatar" class="msg-photo" src="<c:url value="/resources/images/avatar4.png"/>" />
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue user-profile" style="width: 163px;">
