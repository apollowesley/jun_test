...
import cn.jeeweb.beetl.tags.utils.CacheUtils;
...
public class DictUtils {
	...
	public static void initDict() {
		// 字典初始化
		Map<String, InitDictable> baseInterfaceBeans = SpringContextUtils.getApplicationContext().getBeansOfType(InitDictable.class);
