...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>三少_查询页面</title>
        <!-- 
        	因为 find.jsp 这个文件是位于 WEB-INF 里面的，所以不能够通过浏览器直接访问，值能够通过 servlet 进行转发
        因为是通过 servlet 转发来访问 find.jsp 这个文件的，所以当前 find.jsp 文件的路径就是实现转发的那个 servlet 的路径，
        而 servlet 的路径在经过 web.xml 配置文件进行配置过后路径就变成了 webapp/网名
         -->
