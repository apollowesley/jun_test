...
public class PropertiesProvider {
    ...
    private static void initProperties() {
        try {
            props = loadAllProperties("generator.properties", true);
    ...
    public static Properties loadAllProperties(String resourceName, boolean out) throws IOException {
        Properties properties = new Properties();
        if (out) {
            // TODO 读取外部配置文件
            String filePath = System.getProperty("user.dir") + "/" + resourceName;
