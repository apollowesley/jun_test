 ...
 */
package net.oschina.durcframework.easymybatis.spring.boot.autoconfigure;
...
public class MybatisAutoConfiguration {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource dataSource,EasymybatisConfig config) throws Exception {
	...
	@Bean
	@ConditionalOnMissingBean
	public EasymybatisConfig easymybatisConfig(ExternalConfigBean externalConfigBean) {
		EasymybatisConfig config = new EasymybatisConfig();

		config.setCamel2underline(this.properties.isCamel2underline());
		config.setCommonSqlClasspath(this.properties.getCommonSqlClasspath());
		config.setMapperExecutorPoolSize(this.properties.getMapperExecutorPoolSize());
		config.setTemplateClasspath(this.properties.getTemplateClasspath());
		
		if(StringUtils.hasLength(this.properties.getMapperSaveDir())) {
			config.setMapperSaveDir(this.properties.getMapperSaveDir());
		}
		
		MyBeanUtil.copyProperties(externalConfigBean, config);
	...
	public static class AutoConfiguredMapperScannerRegistrar
		...
		public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
			...
			try {
				...
				scanner.setMarkerInterface(Dao.class);
