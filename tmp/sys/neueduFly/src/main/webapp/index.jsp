    ...
    <div class="fly-penel fly-penel-color">
        <div class="layui-container">
            ...
            <div class="fly-panel-right">
                ...
                <a href="page/sendPost.jsp" class="layui-btn">发表新帖</a>
            </div>
        </div>
    </div>
    <div class="layui-container">
        <div class="layui-row layui-col-space15">
            ...
            <div class="layui-col-md8">
                ...
                <div class="carousel-colum">
                    <div class="layui-carousel" id="advert">
                        <div carousel-item>
                            <div><img src="imgs/upload/168_1557540327882_97399.png" /></div>
                            <div><img src="imgs/upload/168_1561705041953_38174.jpg" /></div>
                            <div><img src="imgs/upload/168_1563368495344_70316.jpg" /></div>
                        </div>
                    </div>
                </div>
                <!-- 置顶 -->
                        ...
                        <div class="fly-note-list">
                            <ul>
                                <li class="layui-row">
                                    ...
                                    <div class="layui-col-md1">
                                        <div class="user-header">
                                            <img src="imgs/user-header/6497232.jpg" alt="用户头像" />
                                        </div>
                                    </div>
                                    <!-- 帖子名称 + 用户信息 -->
                                    <div class="layui-col-md10">
                                        <div>
                                            <span class="layui-badge-rim">讨论</span>
                                            <a href="javascript:;">MyLayui plan</a>
                                        </div>
                                        <div class="user-info">
                                            <a href="javascript:;">
                                                <cite>岁月神偷</cite>
                                    ...
                                    <div class="layui-col-md1">
                                        <div class="reply">
                                            <div class="type"><span class="layui-badge">精贴</span></div>
                                            <div class="pinglun">
                                ...
                                <li class="layui-row">
                                    ...
                                    <div class="layui-col-md1">
                                        <div class="user-header">
                                            <img src="imgs/user-header/6174336.jpg" alt="用户头像" />
                                        </div>
                                    </div>
                                    <!-- 帖子名称 + 用户信息 -->
                                    <div class="layui-col-md10">
                                        <div>
                                            <span class="layui-badge-rim">分享</span>
                                            <a href="javascript:;"> layuicdn.com 面向 Layui 用户的免费静态 CDN 库</a>
                                        </div>
                                        <div class="user-info">
                                            <a href="javascript:;">
                                                <cite>DJ李二狗</cite>
                                                ...
                                                <span class="kiss">
                                                    <i class="iconfont icon-kiss"></i>20
                                                </span>
                                                <span class="layui-badge layui-bg-green">已结</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="layui-col-md1">
                                        <div class="reply">
                                            <div class="type"><span class="layui-badge">精贴</span></div>
                                            <div class="pinglun">
                                                <i class="iconfont icon-pinglun1"></i>57
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="fly-panel-style">
                    <div class="fly-panel-title">
                        <span class="layui-breadcrumb note-title" lay-separator="|">
                            <a href="" class="checked-this">综合</a>
                            <a href="">未结</a>
                            <a href="">已结</a>
                            <a href="">精华</a>
                        </span>
                    </div>
                    <div class="layui-row fly-note-list">
                        <ul>
                            <li class="layui-row">
                                <!-- 用户头像 -->
                                <div class="layui-col-md1">
                                ...
                                <div class="layui-col-md10">
                                    ...
                                    <div class="user-info">
                                        <a href="javascript:;">
                                            ...
                                            <span class="time">1天前</span>
                                            <span class="kiss">
                                                <i class="iconfont icon-kiss"></i>500
                                            </span>
                                        </a>
                                    </div>
                                </div>
