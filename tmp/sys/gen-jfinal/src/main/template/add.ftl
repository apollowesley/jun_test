		...
		<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>新增${tableDesc}</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form action="${'$'}{CONTEXT_PATH}/${tableName}/save" method="POST" class="form-horizontal">
