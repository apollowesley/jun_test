...
public class PostUtil {
	...
	private static final Locale DEF_LOCALE = Locale.CHINESE;
	...
	public static String postJSON(String url, Map<String, String> params)throws Exception {
		return post(url, params, UTF8, JSON,DEF_LOCALE);
	}
	
	public static String postXML(String url, Map<String, String> params)throws Exception {
		return post(url, params, UTF8, XML,DEF_LOCALE);
	}
	...
	public static String post(String url, Map<String, String> params,
		...
		return post(url, params, encode, dateType, DEF_LOCALE);
	}
	
	public static String post(String url, Map<String, String> params,String dateType,Locale locale) throws Exception{
		return post(url, params, UTF8, dateType, locale);
	}
	 ...
	 */
	public static String post(String url, Map<String, String> params,
			String encode,String dateType,Locale locale) throws Exception {
		if(encode == null) {
			encode = UTF8;
		}
		...
		try {
			...
			method.setRequestHeader("Accept-Language",locale.toLanguageTag());
