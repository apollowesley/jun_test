...
public class JedisClusterCustom extends JedisCluster {
	...
	public Boolean exists(byte[] bytes) {
		return super.exists(ByteUtil.byteToString(bytes));
	}
	...
	public String set(byte[] bytes, byte[] object) {
		return super.set(ByteUtil.byteToString(bytes),
				ByteUtil.byteToString(object));
	}

	public void expire(byte[] bytes, Integer seconds) {
		super.expire(ByteUtil.byteToString(bytes), seconds);
	}
	
	public Long expire(byte[] bytes, int seconds) {
		return super.expire(ByteUtil.byteToString(bytes), seconds);
	}
