...
<script>
	...
	export default {
		...
		async onLoad() {
			let params = {useStatus:1 };

			let couponValidList = await Api.apiCall('get', Api.index.listMemberCoupon, params);
			this.couponValidList=couponValidList;

			params = {useStatus:2 };

			let couponinvalidList = await Api.apiCall('get', Api.index.listMemberCoupon, params);
			this.couponinvalidList=couponinvalidList;
