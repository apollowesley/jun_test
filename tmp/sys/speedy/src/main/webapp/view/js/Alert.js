var Alert={
	hint:function(message){
		...
		if(null==alert){
			...
			tagDiv.style="z-index:9999;position: fixed;display:flex;align-items:center;justify-content:center;height:100%;width:100%;";
	...
	code:function(title,htmlmessage){
		...
		if(null==alert){
			...
			var tagDiv="<div style='z-index:9998;position:fixed;background:#fff;border:1px solid #666;overflow:hidden;box-shadow:1px 1px 1px #999999;top:25%;'><p>"+title+"</p><p style='font-size:14px;padding-left:50px;padding-right:50px;'>"+htmlmessage+"</p><p><button id='close' style='width: 70px;height:30px;'>关闭</button></p></div>";
