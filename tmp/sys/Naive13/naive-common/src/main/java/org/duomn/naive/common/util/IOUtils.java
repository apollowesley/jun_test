...
public class IOUtils {
	...
	/**
	 * 根据JUpload上传的文件的Name属性，获取多文件的序号
	 * @param name
	 * @return 多文件返回对应的文件序号；单文件name为空，返回""
	 */
	public static String getJUploadFileIndexByName(String name) {
		if (name == null) return "";
		return name.replaceAll("[fF]ile", ""); // 替换file或者File
	}
}
