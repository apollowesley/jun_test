package com.mkfree.hbase.example.service;
...
public class HBaseService {
    ...
    public HBaseService() {
        ...
        this.conf.set("hbase.zookeeper.quorum","hb-proxy-pub-wz95d8474e452itz6-master1-001.hbase.rds.aliyuncs.com:2181,hb-proxy-pub-wz95d8474e452itz6-master2-001.hbase.rds.aliyuncs.com:2181,hb-proxy-pub-wz95d8474e452itz6-master3-001.hbase.rds.aliyuncs.com:2181");
        try {
     ...
     * @return java.util.Map<java.lang.String       ,       java.util.Map       <       java.lang.String       ,       java.lang.String>>
     */
    public Map<String, Map<String, String>> getResultScanner(String tableName, Long startRowKey, Long stopRowKey) {
        Scan scan = new Scan();
     ...
     */
    public Map<String, String> getRowData(String tableName, Long rowKey) {
        //返回的键值对
...
//                System.out.println("-------------------------------------------");
     ...
     * @param values 列值得数组
     */
    public void putData(String tableName, Long rowKey, String familyName, String[] columns, String[] values) {
        // 获取表
        Table table = null;
        try {
            table = getTable(tableName);
     ...
     * @param values 列值得数组
     */
    private void putData(Table table, Long rowKey, String tableName, String familyName, String[] columns, String[] values) {
        try {
            //设置rowkey
            Put put = new Put(Bytes.toBytes(rowKey));
