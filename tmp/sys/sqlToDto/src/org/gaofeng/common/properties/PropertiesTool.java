...
public class PropertiesTool {
	...
	public static String TABLE_SCHEMA = getStringProperty("tableSchema");
	public static String DOMAIN_EXTENDS = getStringProperty("domainExtends");
	/**
	 * 后缀
	 */
	 ...
	 * 前缀
	 */
	public static String BEANSREFIXNAME = getStringProperty("beanSrefixName");
