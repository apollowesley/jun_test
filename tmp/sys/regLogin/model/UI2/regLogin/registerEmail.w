...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card"
          ...
          <div class="panel-heading"> 
            ...
            <div class="media-body" style="width:119px;"> 
              <input component="$UI/system/components/justep/input/input" class="form-control input-sm tb-noborder text-muted"
                xid="email" style="width:202px;" bind-text="" bind-ref='$model.userData.ref("fPhoneNumber")'/> 
            </div> 
          </div>  
   ...
   <div class="media-body" xid="div5" style="width:133px;">
    <input component="$UI/system/components/justep/input/input" class="form-control" xid="password" style="width:128px;height:32px;" bind-ref='$model.userData.ref("passwd")'></input></div> 
   </div>
