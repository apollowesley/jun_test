    ...
    <view class="uni-tab-bar">
        ...
        <scroll-view class="list" scroll-y   @scrolltolower="loadMore()" upper-threshold="50" @scrolltoupper="scrolltoupper">
            ...
            <block v-for="(newsItem, newsIndex) in listData" :key="newsItem.id">
                <uni-media-list :options="newsItem" @close="dislike(newsIndex)" @click="goDetail(newsItem)"></uni-media-list>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            // tabIndex() {
            //     this.newsList = this.tabBars[this.tabIndex].data || [];
            // }
        },
        onLoad: function() {
            ...
            //     tabBar.ref = tabBar.name,
            //         // id: 'tabBar' + index,
            //         tabBar.data = [],
            //         tabBar.requestParams = {
            //             category_id: tabBar.id,
            //             minId: 0,
            //             pageSize: 10,
            //             column: 'id,post_id,title,author_name,cover,published_at,comments_count'
            //         }
            //     tabBar.loadingText = '加载中...'
            // })
            this.getList(0);
