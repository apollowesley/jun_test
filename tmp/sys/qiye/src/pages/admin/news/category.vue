      ...
      <div class="custom-tree-node" slot-scope="{ node, data }" >
        ...
        <span class="tree-right" >
            <span v-if="data.id"  class="tree-span">
                ...
                <span class="tree-span" >URL: <span class="tree-tip">news/category/{{data.id}}</span></span>
                <el-button
                    type="text"
                    size="mini"
            ...
            <div class="form-box" style="align-self: center;">
            	<el-form ref="form" :model="form" label-width="100px" style="padding-top: 20px;">
                    ...
                    <el-form-item label="栏目板块" style="text-align: left;">
                    	<el-cascader change-on-select  :options="categoryList"  v-model="genealogy"  :props="props"  >
                    	</el-cascader>
                    </el-form-item>
        ...
        methods: {
          ...
          remove(data,node) {
            ...
            handleEdit(type, row) {
                ...
                switch (type) {
                    case 'add':
                        formUp.pid=formUp.id || 0;
                        formUp.ranking=10;
                        formUp.image='';
                        
                        formUp.state=formUp.state || 1;
                        formUp.id=formUp.id || 0;
                        this.imgList=[];

                        formUp.genealogy.push(formUp.pid);
                        formUp.id=0;
                        this.form=formUp;
                        break;
                    case 'edit':
