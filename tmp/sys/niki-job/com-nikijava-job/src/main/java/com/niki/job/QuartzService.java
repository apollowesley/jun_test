...
public class QuartzService {
    ...
    public boolean isExist(String jobName, String schedulerGroupName) throws Exception {
        JobKey jobKey = JobKey.jobKey(jobName, schedulerGroupName);
        return scheduler.checkExists(jobKey);
    }

    public boolean isSame(String jobName, String schedulerGroupName, String cronStr) throws Exception {
        JobKey jobKey = JobKey.jobKey(jobName, schedulerGroupName);
        List<? extends Trigger> triggers = scheduler.getTriggersOfJob(jobKey);
        for (Trigger t : triggers) {
            if (cronStr.equals(((CronTrigger) t).getCronExpression())) {
                return true;
            }
        }
        return false;
