defmodule FormlessWeb.ColumnControllerTest do
  use FormlessWeb.ConnCase

  alias Formless.Store

  @create_attrs %{data_type: "some data_type", desc: "some desc", field_name: "some field_name", name: "some name"}
  ...
  def fixture(:column) do
    {:ok, column} = Store.create_column(@create_attrs)
    column
  end
