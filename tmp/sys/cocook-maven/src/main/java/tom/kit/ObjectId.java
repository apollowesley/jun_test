...
public class ObjectId implements Comparable<ObjectId> , java.io.Serializable {
    ...
    public String toStringMongod(){  // 16进制字符串
        byte b[] = toByteArray();
    ...
    public long toLong() {
    	BigInteger bigInteger = new BigInteger(toByteArray());
    	return bigInteger.longValue();
    }
    
    public String toBigNum() { // 很大的 数据
    	BigInteger bigInteger = new BigInteger(toByteArray());
    ...
    public static void main(String[] args) {
		...
		System.out.println(id.toLong());  // 这个效率超快
		System.out.println(id.toBigNum()); // 这个效率差
