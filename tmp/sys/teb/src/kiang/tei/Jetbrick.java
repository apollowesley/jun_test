...
public final class Jetbrick implements TebEngine {
    ...
    public TebEngine init(Properties properties) throws Exception {
        ...
        ps.setProperty(JetConfig.COMPILE_DEBUG, "false");
        ...
        ps.setProperty(JetConfig.TEMPLATE_LOADER, "jetbrick.template.resource.loader.ClasspathResourceLoader");
        ps.setProperty(JetConfig.TEMPLATE_PATH, "");
