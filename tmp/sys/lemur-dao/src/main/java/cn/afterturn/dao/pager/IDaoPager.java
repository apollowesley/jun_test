package cn.afterturn.dao.pager;
 ...
 * 分页信息
 * @author JueYue
 * @date 2014年12月11日 下午9:40:48
 * @param <E>
 */
public class IDaoPager<E> extends ArrayList<E> {
     ...
     */
    public IDaoPager(int itemsPerPage) {
     ...
     * @param items 总项数
     */
    public IDaoPager(int itemsPerPage, int items) {
