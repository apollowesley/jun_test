...
public class HelloWorldWSImpl implements HelloWorldWS {
    ...
    static {
        listUser.add(new User("kiwipeach", "123456"));
...
//    @WebMethod 不允许使用Map进行返回（javax.xml.bind.JAXBException: return is not a valid property on class cn.kiwipeach.ws.api.impl.jaxws.GetMapUserResponse）
//    @Override
