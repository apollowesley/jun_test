...
//		任意整数
		...
		assertEquals(false, MsgValidator.valid(cup1, cfgs));
		assertEquals(false, MsgValidator.valid(cup2, cfgs));
	}
...
//		任意整数
		...
		Cup cup3 = new Cup("0");
		String cfgs = "{name:'required;integer'}";
		assertEquals(true, MsgValidator.valid(cup, cfgs));
		assertEquals(true, MsgValidator.valid(cup2, cfgs));
		assertEquals(true, MsgValidator.valid(cup3, cfgs));
...
//		负整数+0
		...
		Cup cup3 = new Cup("0");
		String cfgs = "{name:'required;integer:-0'}";
		assertEquals(false, MsgValidator.valid(cup, cfgs));
		assertEquals(true, MsgValidator.valid(cup2, cfgs));
		assertEquals(true, MsgValidator.valid(cup3, cfgs));
	}
...
//		负整数
		...
		assertEquals(false, MsgValidator.valid(cup, cfgs));
		assertEquals(true, MsgValidator.valid(cup2, cfgs));
		assertEquals(false, MsgValidator.valid(cup3, cfgs));
	}
...
//		范围域的验证
		...
		assertEquals(false, MsgValidator.valid(cup1, cfgs1));
		assertEquals(true, MsgValidator.valid(cup2, cfgs1));
		assertEquals(true, MsgValidator.valid(cup3, cfgs1));
		
		assertEquals(true, MsgValidator.valid(cup1, cfgs2));
		assertEquals(false, MsgValidator.valid(cup2, cfgs2));
		assertEquals(false, MsgValidator.valid(cup4, cfgs2));
	}
...
//		离散域的验证
		...
		assertEquals(true, MsgValidator.valid(cup2, cfgs));
		assertEquals(false, MsgValidator.valid(cup3, cfgs));
		assertEquals(true, MsgValidator.valid(cup4, cfgs));
	}
...
//		离散域+范围域的验证
		...
		assertEquals(false, MsgValidator.valid(cup3, cfgs));
		assertEquals(true, MsgValidator.valid(cup4, cfgs));
		assertEquals(true, MsgValidator.valid(cup5, cfgs));
		assertEquals(false, MsgValidator.valid(cup6, cfgs));
	}
	...
	public void compare1(){
		...
		assertEquals(true, MsgValidator.valid(cup1, cfgs1));
		assertEquals(true, MsgValidator.valid(cup2, cfgs2));
		...
		assertEquals(false, MsgValidator.valid(cup3, cfgs3));
		assertEquals(false, MsgValidator.valid(cup4, cfgs4));
	}
	...
	public void compare2(){
		...
		assertEquals(true, MsgValidator.valid(p1, cfgs1));
		...
		assertEquals(true, MsgValidator.valid(p2, cfgs2));
		...
		assertEquals(false, MsgValidator.valid(p3, cfgs3));
...
//		Product p4 = new Product(new BigDecimal("100"), new BigDecimal("100"));
		...
		assertEquals(true, MsgValidator.valid(p4, cfgs4));
