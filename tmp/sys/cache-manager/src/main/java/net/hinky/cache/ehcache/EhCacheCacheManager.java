package net.hinky.cache.ehcache;

import java.io.InputStream;
import java.net.URL;

import net.hinky.cache.AbstractCacheManager;
import net.hinky.cache.Cache;
import net.hinky.cache.CacheException;
...
public class EhCacheCacheManager extends AbstractCacheManager {
	...
	public EhCacheCacheManager(InputStream configurationInputStream)
	...
	public EhCacheCacheManager(Configuration configuration)
			throws CacheException {
