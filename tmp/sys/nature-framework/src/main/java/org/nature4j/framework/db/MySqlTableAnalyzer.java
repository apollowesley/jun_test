...
public class MySqlTableAnalyzer {
	...
	Db natureDb ;
	public static MySqlTableAnalyzer use(Db natureDb) {
		MySqlTableAnalyzer sqlTableAnalyzer = new MySqlTableAnalyzer();
	...
	public List<String> getSqlList() {
		...
		NatureService natureService = (NatureService) ServiceHelper.getService(NatureService.class);
			List<NatureMap> query1 = natureService.list(natureDb,"SHOW TABLES");
			for (NatureMap natureMap : query1) {
				...
				for (String key : keySet) {
					...
					List<NatureMap> query2 = natureService.list(natureDb,"DESC " + tableName);
