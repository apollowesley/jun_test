...
App({
  globalData: {
    appid: 'wx4dcee834cc6446dd', //appid需自己提供
    secret: '26329cd30805ed9d3feca6e80b9602bf', //secret需自己提供
    token: 'weixinCourse'
  },
  onLaunch: function() {
    var that = this;
          ...
          if (res.code) {
            ...
            wx.request({
              ...
              success: function(mation) {
                if (mation.statusCode == 200){
                  if (mation.data.openid){
                    var obj = {
                      openid: mation.data.openid,
                      expires_in: Date.now() + mation.data.expires_in
                    };
