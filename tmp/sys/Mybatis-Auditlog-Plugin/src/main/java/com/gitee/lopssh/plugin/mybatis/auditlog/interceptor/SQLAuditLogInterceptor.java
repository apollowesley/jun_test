...
import com.gitee.lopssh.plugin.mybatis.auditlog.interceptor.handler.*;
...
public class SQLAuditLogInterceptor implements Interceptor
{
    ...
    {
        Boolean splitEnableOption = Boolean.valueOf(properties.getProperty("split", Boolean.TRUE.toString()));
