...
<s:set var="haveRight" value="@com.evil.util.ValidateUtil@hasRight('/ExamTypeAction_doSaveOrUpdateExamType')"  />
	<form method="post" action="${haveRight?'ExamTypeAction_doSaveOrUpdateExamType':'#' }" class="pageForm" onsubmit="return validateCallback(this,dialogAjaxDone)">
		<div layoutH="80">
			<table>
				<tbody>
					<tr>
