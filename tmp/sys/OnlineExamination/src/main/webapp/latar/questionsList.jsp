...
<form id="pagerForm" method="post" action="QuestionAction_doTopic?questionPage=typeQuestionsListPage"
	onsubmit="return divSearch(this, 'jbsxBox');">
	<input type="hidden" name="questionsType"
		value="${model.questionsType }"> <input type="hidden"
		name="title" value="${model.title }"> <input type="hidden"
...
<body>
	...
	<div class="pageHeader" style="border: 1px #B8D0D6 solid">
		<form target="navTab" rel="pageForm" action="QuestionAction_doTopic?questionPage=typeQuestionsListPage"
			method="post" onsubmit="return divSearch(this, 'jbsxBox');">
	...
	<div class="pageContent"
		...
		<div class="panelBar">
			<ul class="toolBar">
				<li><s:a cssClass="add"
					action="QuestionAction_toEditQuestionPage?questionsType=%{model.questionsType }&tid=%{tid }&questionPage=editQuestionPage"
					target="dialog" width="590" height="600"><span>添加</span></s:a></li>
				<li><s:a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids"
					action="QuestionAction_bacthDeleteQuestions" postType="string"
					cssClass="delete"><span>删除</span></s:a></li>
				<li><s:a cssClass="edit"
					action="QuestionAction_toEditQuestionPage?qid={questionId}&tid=%{tid }&questionPage=editQuestionPage"
					target="dialog" width="590" height="600" warn="请选择一条信息"><span>修改</span></s:a></li>
				<li><s:a cssClass="icon"
					action="QuestionAction_toMoveQuestionPage"
					target="selectMore" rel="ids" width="300" height="550" ><span>移动</span></s:a></li>	
				<li class="line">line</li>
				<li><a class="icon"
					href="javascript:$.printBox('questions_list_print')"><span>打印</span></a></li>
			</ul>
		</div>
		...
		<s:else>
			<div>
				<div id="questions_list_print">
					<table class="list" width="100%" targetType="navTab" layoutH="108"
						rel="jbsxBox">
						<thead>
							<tr>
								<th width="22"><input type="checkbox" group="ids"
									class="checkboxCtrl"></th>
								<th width="60" orderField="id"
									<c:if test='${param.orderField=="id" }'>class="${param.orderDirection}"</c:if>>问题id</th>
				...
				<div class="panelBar">
					...
					<div class="pagination" rel="jbsxBox" targetType="navTab"
