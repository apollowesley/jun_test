...
<body>
	...
	<div class="pageContent" style="padding: 5px">
		...
		<div layoutH="20"
			...
			<div>
				<ul class="tree treeFolder expand" id="questionsList">
					<li><a href="javascript">题型选择</a>
						<ul>
							<li><a href="QuestionAction_doTopic?questionsType=0"
								...
								<ul>
									<li><a href="QuestionAction_doTopic?questionsType=0"
										target="ajax" rel="jbsxBox">单选题</a></li>
								</ul></li>
							<li><a href="QuestionAction_doTopic?questionsType=1"
								target="ajax" rel="jbsxBox">多选题</a></li>
							<li><a href="QuestionAction_doTopic?questionsType=2"
								target="ajax" rel="jbsxBox">判断题</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
		<div id="jbsxBox" class="unitBox" style="margin-left: 156px;"></div>
	</div>
</body>
</html>
