...
INSERT INTO `user_info` (`uid`,`username`,`name`,`password`,`salt`,`state`) VALUES ('2', 'test', 'test', '4eb4ebbd7ff013de128481ec9c3575be', '80424d4bf4f8d78869f4709513329595', 1);
...
INSERT INTO `sys_user_role` (`role_id`,`uid`) VALUES (3,2);