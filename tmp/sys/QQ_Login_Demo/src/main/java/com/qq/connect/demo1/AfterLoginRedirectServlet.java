 ...
 * Time: 下午4:36
 */
//@WebServlet(name="after-login-servlet", urlPatterns={"/qqlogin/callback"})
...
//                做一些数据统计工作
                ...
                out.println("<p> start ---------------------没有获取到响应参数--------------利用获取到的accessToken,openid 去获取用户在Qzone的昵称等信息 ---------------------------- start </p>");
                ...
                if (userInfoBean.getRet() == 0) {
                    ...
                    out.println("<img src=" + userInfoBean.getAvatar().getAvatarURL30() + " ><br/>");
                    out.println("<img src=" + userInfoBean.getAvatar().getAvatarURL50() + " ><br/>");
                    out.println("<img src=" + userInfoBean.getAvatar().getAvatarURL100() + "><br/>");
                } else {
