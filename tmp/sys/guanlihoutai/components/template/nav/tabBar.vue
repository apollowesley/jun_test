<template>
    ...
    <view class="uni-flex uni-row page-temp-tab-bar" style="z-index: 1;box-shadow:-2px 0px 2px  #888888;justify-content:space-between;width: 100vw;align-items: center;padding: 0 10px;box-sizing: border-box;"
        :style="'height:'+Height+'px;'">
        <view v-for="(item,idx) in tabBarData" :key="idx">
            ...
            <view style="justify-content: center;align-items: center;" v-else :style="item.style?item.style:'flex:1'"
                ...
                <view v-else-if="item.text" class="uni-flex" style="line-height:26px;">
