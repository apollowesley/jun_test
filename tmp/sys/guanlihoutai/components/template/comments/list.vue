        ...
        <view class="uni-comment-list">
            ...
            <view style="width: 100%;">
                <view class="uni-comment-right-body" style="font-size: 1em;">
                    ...
                    <view @tap="tapBtn({key:'content',items,level:1})" class="uni-comment-content">
                        <view v-for="(item,index) in items.content" :key="index">
                            <view class="" v-if="index=='text'">
                                {{item}}
                            </view>
                            <image class="" :src="item" v-if="index=='image'">
                            </image>
                        </view>
                    </view>
