<template>
    ...
    <view class="uni-page-body">
        <view class="yc-ul">
            <view class="qiun-title-bar uni-row uni-flex" style="background-color: #E5FDC3;">
                <view class="qiun-title-dot-light uni-flex uni-column" style="flex: 1;justify-content:space-between">
    ...
    export default {
        ...
        methods: {
            ...
            showLineA(canvasId, chartData) {
                ...
                (chartData.series[0].data).filter(e => {
                    count = count + e;
                })
                this.count = count;
