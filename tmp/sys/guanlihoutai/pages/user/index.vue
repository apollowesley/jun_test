    ...
    <view class="uni-page-body">
        <view class="yc-ul">
            <view class="qiun-title-bar" style="background-color: #E5FDC3;">
                <view class="qiun-title-dot-light uni-flex" style="justify-content:space-between">
                    <view class="uni-flex-item">
                        月注册用户量:{{count}}
                    </view>
                    <view class="uni-flex uni-row" style="width: 250upx;justify-content:space-around">
