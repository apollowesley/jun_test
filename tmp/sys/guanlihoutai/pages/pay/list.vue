    ...
    <view class="uni-page-body">
        ...
        <view class="" v-else>
            ...
            <scroll-view @scrolltolower="scrolltolower" scroll-y :style="'height:'+contentHeight+'px' " class="yc-ul">
                <view class="yc-li">
                    <view class="yc-li-item uni-flex uni-row" style="justify-content: space-between;font-size: 0.7em;text-align: center;">
                ...
                <view class="yc-li" v-for="(item,index) in list" :key="item.id" style="white-space: nowrap;overflow-x: auto;">
                    <view class="yc-li-item" style="justify-content: space-between;font-size: 0.7em;" @tap="tapItem(item)">
                        <view class="" style="width: 60px;white-space: nowrap;overflow: auto;">
                            <text v-if="item.amount>0">进账</text>
                            <text v-else>出账</text>
                        </view>
                        <view class="" style="width: 60px;white-space: nowrap;overflow: auto;">
                            {{item.id}}
                        ...
                        <view class="" style="width: 60px; text-align: center;">
                            <view class="" :style="item.amount>0?'color: #09BB07;':'color: red;'">
                                {{item.amount}}
                            </view>
                        </view>
                        <view class="" style="width: 60px; text-align: center;">
                        ...
                        <view class="" style="width: 100px;  text-align: center;">
                            {{item.time|time}}
...
<script>
    ...
    export default {
        ...
        filters: {
            time(e) {
                return Time.formatDate(e, 'yy-MM-dd hh:mm')
            },
            state(e) {
                // console.log(e)
                var arr = {
