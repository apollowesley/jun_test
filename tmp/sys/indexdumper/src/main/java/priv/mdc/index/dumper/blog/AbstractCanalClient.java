...
public class AbstractCanalClient {
    ...
    protected BinlogEventNotifier             notifier           = null;
...
//                            String.valueOf(entry.getHeader().getExecuteTime()), String.valueOf(delayTime) });
                ...
                for (RowData rowData : rowChage.getRowDatasList()) {
                    ...
                    if(notifier!=null){
                    	notifier.notify(destination, entry.getHeader().getSchemaName(), entry.getHeader().getTableName(), eventType, columns);
                    }
                }
            }
        }
	...
	public void setNotifier(BinlogEventNotifier notifier) {
