...
public class XlsAccessorParam extends XlsAccessor {
	 ...
	 * @return
	 */
	private Object[] getParamValues(String value) {
		...
		return DynaBinder.INSTANCE.binder(paramsValue, null, getField().getGenericType());
	}
	 ...
	 * @return
	 */
	private String getValueParams(Object value) {
		if (value == null) {
			return null;
		}
