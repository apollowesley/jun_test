...
public class CreateBean {
    ...
    public boolean createJavaBean(Connection connection, String SqlString, String packageStr, boolean flag) {
        ...
        try {
            ...
            sb.append("package").append(" ").append(packSrc).append(";");
            // 追加换行符号
            sb.append(LINE);
            /**
     ...
     * @param sb
     */
    public void genSetGetMethod(ResultSetMetaData rsmetaData, int columnCount, StringBuffer sb) {
        try {
     ...
     * @param sb
     */
    public void importPackage(ResultSetMetaData rsmetaData, int columnCount, StringBuffer sb) {
        try {
            for (int i = 1; i <= columnCount; i++) {
     ...
     * @param filePath
     */
    public void createJavaFile(String filePath, String className, String fileContent) {
        try {
            dirExist(filePath);
