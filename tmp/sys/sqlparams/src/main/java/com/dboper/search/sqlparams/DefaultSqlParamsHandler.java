...
public class DefaultSqlParamsHandler {
	...
	/**
	 * 对于getSqlWhereParamsResult(Map<String,Object> params)方法返回的baseWhereSql是带有占位符的
	 * 这个方法可以让你进行定制，是否用占位符
	 * @param params
	 * @param isPlaceHolder 如果为false，表示不使用占位符，则返回的baseWhereSql如   a.id>12
	 * @return
	 */
	public SqlParamsParseResult getSqlWhereParamsResult(Map<String,Object> params,boolean isPlaceHolder){
		return getSqlWhereParamsResultByAndOr(params,AND,isPlaceHolder,new SqlParamsParseResult());
	}
