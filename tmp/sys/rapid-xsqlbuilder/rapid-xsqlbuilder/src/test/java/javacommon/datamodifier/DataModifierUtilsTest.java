...
public class DataModifierUtilsTest extends TestCase
{
    ...
    public void testModifierWithArgument()
        throws Exception
    {
    ...
    public void testRegisterNewModifer()
        throws Exception
    {
    ...
    public void testDeregisterDataModifier()
    {
        ...
        // 重新注册，否则会导致使用到xxx?int的junit单元测试代码运行fail
        DataModifierUtils.registerDataModifier("int", new IntegerDataModifier());
    }
