...
public class SqlTemplate extends  AbstractTemplate{
    ...
    protected String buildSingleParamSql(String prefix, String column, String columnTwo, Table model, String keyword){
        ...
        if(StringUtils.isEmpty(javaType)){
        	Column col = model.getField(column);
        	if(col == null){
        		throw new DalSqlException("Column "+column+" is not exist in table "+model.getTableName());
        	}
            javaType = MybatisJavaTypeResolver.calculateJavaType(col.getJdbcType());
        }
