...
public interface MongoDAL {
    ...
    QueryResult selectGroupByCriteria(QueryCriteria queryCriteria);
    QueryResult selectGroupByCriteria(QueryCriteria queryCriteria, int seconds);
    ...
    Object insertMany(String table, List<Object> list);
