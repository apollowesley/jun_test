...
public interface ObjectFactory {
     ...
     * the object should be fully constructed.  {@link com.tbc.soa.json.ObjectBinder} can be used to bind values into
     * the object according to default rules.  For simple implementations you won't need to use this, but
     * for more complex or generic objects reusing methods like {@link com.tbc.soa.json.ObjectBinder#bind(Object, java.lang.reflect.Type)}
     * and {@link com.tbc.soa.json.ObjectBinder#bindIntoCollection(java.util.Collection, java.util.Collection, java.lang.reflect.Type)}.
     *
