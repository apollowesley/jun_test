...
标签（空格分隔）： 资料
#####原创出处:https://coding.net/u/f2e/p/Books/git/tree/master/%E7%A7%BB%E5%8A%A8Web
#####转载出处:https://github.com/yyman001?tab=repositories
...
- [ZUI - 一个开源前端实践方案，帮助你快速构现代跨屏应用。](http://zui.sexy/)
- [WeX5开源前端](http://git.oschina.net/X5OK/WeX5)
- [B-JUI](http://git.oschina.net/xknaan/B-JUI)
...
####32. 布局(Layout)
- 分隔面板[split-pane](https://github.com/shagstrom/split-pane)
