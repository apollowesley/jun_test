...
public @interface FooColumn {
	 ...
	 * <code>UniqueConstraint</code> annotation at the table level and is
	 * useful for when the unique key constraint corresponds to only a single
	 * column. This constraint applies in addition to any constraint entailed by
	 * primary key mapping and to constraints specified at the table level.
	 */
