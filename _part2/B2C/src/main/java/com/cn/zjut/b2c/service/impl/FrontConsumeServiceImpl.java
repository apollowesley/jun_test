...
@Service("frontConsumeService")
public class FrontConsumeServiceImpl implements FrontConsumeServiceInter {
	...
	public String getFrontRequestUrl() {
		return SDKConfig.getConfig().getFrontRequestUrl();  //获取请求银联的前台地址：对应属性文件acp_sdk.properties文件中的acpsdk.frontTransUrl
	}
