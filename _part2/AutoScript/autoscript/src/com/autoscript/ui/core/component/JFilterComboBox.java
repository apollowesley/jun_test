...
//                	System.out.println("name:"+name+",editortext:"+getEditorText());
                    showModel.addElement(model.getElementAt(i));  
                }  
            }  
//            System.out.println("showModel.getSize():"+showModel.getSize());
            ((FilterComboPopup)popup ).setListModel(showModel);
...
//        panel.add(new JFilterComboBox(data));
        JFilterComboBox comp = new JFilterComboBox();
		panel.add(comp);
		DefaultComboBoxModel aModel = new DefaultComboBoxModel(data); 
		comp.setModel(aModel);
