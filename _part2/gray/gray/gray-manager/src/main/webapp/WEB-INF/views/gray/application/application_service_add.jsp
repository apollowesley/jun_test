        ...
        <form id="applicationServiceAddForm" method="post">
            <table class="grid">
                    ...
                    <td>
                    	<select id="type" name="type" class="easyui-combobox" data-options="width:140,required:true,editable:false,panelHeight:'auto'">
                             <c:forEach var="item"   items="${engineList }">
                             	<option value="${item.settingValue}">${item.remark}</option>
                             </c:forEach>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td>灰度策略</td>
                    <td colspan="3">
                    	<input id="serviceStrategy" class="easyui-combobox" 
                    	data-options="width:200,required:true,valueField:'id',textField:'name',url:'${path}/strategy/getStrategyByType'">
                    	<input type="hidden" id="serviceStrategyValue"  name="strategy_nginx" >
                    </td>
                </tr>
                <tr>
                    <td>备注</td>
