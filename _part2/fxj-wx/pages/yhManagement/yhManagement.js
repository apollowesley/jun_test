...
Page({
    ...
    goCustomerInfo: function (e) {
        ...
        wx.navigateTo({
          url: "/pages/customeryhInfo/customeryhInfo?orderNo=" + orderNo + '&proNo=' + proNo
        })
  ...
  //视频查看
  goVideoView: function (e) {
    var orderNo = e.currentTarget.dataset.orderno;
    wx.navigateTo({
      url: "/pages/videoView/videoView?orderNo=" + orderNo
    })
  },


  definiteRevocation: function (e) {
    var orderNo = e.currentTarget.dataset.orderno;
    ...
    wx.showModal({
      ...
      success: function (res) {
        ...
        if (res.confirm) {
          wx.request({
            url: pathUrl + '/rest/fxjMqLogController/stop' ,
            data: {
                        roomNo: orderNo
             },
            method: 'PUT',
    ...
    goSignedFace:function(e){
        ...
        wx.navigateTo({
          url: `/pages/meetingno/meetingno?channel=${orderNo}&uid=${uid}&role=broadcaster`
        });     
    },
    //补充材料
    goannex: function () {
    ...
    goPaymentSchedule: function (e) {
        var orderNo = e.currentTarget.dataset.orderno;
        wx.navigateTo({
          url: "/pages/paymentScheduleyh/paymentScheduleyh?orderNo=" + orderNo
        })
    ...
    onReachBottom: function () {
        ...
        wx.request({
          url: pathUrl + '/rest/fxjOrderMainController/listyh/' + that.data.openId,
            data: {
                orderStatusType: that.data.orderStatusType,
