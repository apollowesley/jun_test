...
import cn.backflow.generator.util.typemapping.ActionScriptDataTypesUtils;
import cn.backflow.generator.util.typemapping.JavaImport;
...
public class JavaClass {
    ...
    private <T> List<T> exclude(T[] methods, T[] excludeMethods) {
        ...
        for (T method : methods) {
            for (T excludeMethod : excludeMethods) {
