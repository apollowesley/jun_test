...
<div class="container">
  <section class="page-title">
    <div class="row">
      <div class="col-sm-8">
        <h1 class="main-title">新增${table.tableAlias}</h1>
  ...
  <div class="row row-fullw bg-white">
    <form:form modelAttribute="${classNameFirstLower}" action="<@jspEl 'ctx'/>${classNameLower}/create" method="post" class="validation-form" role="form">
