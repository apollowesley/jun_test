		            	...
		            	<form class="form-horizontal" role="form" method="post">
		                  ...
		                  <div class="form-group">
		                    <div class="col-sm-5 col-sm-offset-3">
		                      <button id="user_login" type="button" class="btn btn-primary">登&nbsp;&nbsp;录</button>
		                    </div>
		                  </div>
		                </form>
	                </div>
	                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
	                	<p class="site a">还没有账号？<a href="<?=base_url(); ?>user/register.html">立即注册</a></p>
						<p>推荐使用社交账号登录：</p>
						<p class="site a">
