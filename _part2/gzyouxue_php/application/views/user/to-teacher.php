                	...
                	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    	<form class="form-horizontal" role="form" method="post">
                          ...
                          <div class="form-group">
                            <label for="t_type" class="col-sm-2 control-label">我是</label>
                                <div class="col-sm-10">
                                	<div id="radio_t_type" class="radio">
                                      <input type="radio" name="radio_t_type" id="type-student" value="在校大学生">
                                      <label for="type-student">在校大学生</label>
                                      &nbsp;&nbsp;&nbsp;&nbsp;
                                      <input type="radio" name="radio_t_type" id="type-teacher" value="在职教师">
                                      <label for="type-teacher">在职教师</label>
                                       &nbsp;&nbsp;&nbsp;&nbsp;
                                      <input type="radio" name="radio_t_type" id="type-other" value="其他">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" class="form-control" id="where_from" name="where_from" placeholder="请输入您来自于哪个学校或哪个单位，大学生请具体到专业">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-2">
                              <button id="user_add_teacher_info" type="button" class="btn btn-primary">保存</button>
                              <a href="<?=base_url(); ?>user/profile/teacher.html" class="btn btn-primary">取消</a>
                            </div>
                          </div>
                        </form>
                    </div>
    ...
    <script>
    	...
    	$('#select_speciality').multiselect({
			...
			onChange: function(option, checked) {
				selectLimit("select_speciality", option, checked, 3);
            }
		});
		$('input[name="radio_t_type"]').iCheck({
