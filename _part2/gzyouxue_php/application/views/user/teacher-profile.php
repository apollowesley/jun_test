    	...
    	<div class="row row-offcanvas row-offcanvas-left">
            ...
            <div class="col-xs-12 col-sm-7 col-md-8 col-lg-9">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                    		<p class="site section-title">教师信息</p>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                            <p><?=empty($user->t_type) ? PROFILE_EMPTY : $user->t_type; ?></p>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            <p>来自于：</p>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                            <p><?=empty($user->where_from) ? PROFILE_EMPTY : $user->where_from; ?></p>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            <p>专长：</p>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                            <p><?=empty($user->speciality) ? PROFILE_EMPTY : $user->speciality; ?></p>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            <p>自我评价：</p>
                        </div>
               ...
               <a href="<?=base_url(); ?>user/teacher/edit_teacher.html" class="btn btn-primary">编辑我的信息</a>
