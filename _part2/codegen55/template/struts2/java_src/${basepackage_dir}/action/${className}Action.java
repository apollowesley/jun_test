...
public class ${className}Action extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	public void prepare() throws Exception {
		if (isNullOrEmptyString(id)) {
			...
			${classNameFirstLower} = (${className})${classNameFirstLower}Manager.getById(id);
		}
	}
	...
	public String list() {
		...
		Page page = ${classNameFirstLower}Manager.findPage(query);
		savePage(page,query);
		return LIST_JSP;
	}
	...
	public String update() {
		${classNameFirstLower}Manager.update(this.${classNameFirstLower});
