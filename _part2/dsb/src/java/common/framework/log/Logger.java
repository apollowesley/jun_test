...
public class Logger {
	/** Kernel Level */
	public static int KERNEL_LEVEL = 0;
	/** LOW Level */
	public static int LOW_LEVEL = KERNEL_LEVEL + 1;
	/** Function Level */
	public static int FUNCTION_LEVEL = LOW_LEVEL + 1;
	/** Sanity Level */
	public static int SANITY_LEVEL = FUNCTION_LEVEL + 1;
	/** Program Level */
	public static int PROGRAM_LEVEL = SANITY_LEVEL + 1;
	/** Fatal Level */
	public static int FATAL_LEVEL = PROGRAM_LEVEL + 1;

	private static final String LOG_LEVEL_CODES[] = { "KERNEL", "LOW", "FUNCTION", "SANITY", "PROGRAM", "FATAL", "NOLOG" };
	...
	private static int LOG_LEVEL = SANITY_LEVEL; // default loglevel
	...
	public static void log(int logLevel, String title, String message) {
		...
		WRITER.println(">> " + date + "; " + "Thr:" + Thread.currentThread().getName() + "; " + "LogLvl:" + LOG_LEVEL_CODES[logLevel] + "; " + getWhere() + "; ");
	...
	public static void log(int logLevel, String message) {
		...
		String date = formatter.format(Calendar.getInstance().getTime());
		WRITER.println(">> " + date + "; " + "Thr:" + Thread.currentThread().getName() + "; LogLvl:" + LOG_LEVEL_CODES[logLevel] + "; Where:" + getWhere() + "; ");
		WRITER.println(message);
		WRITER.flush();
	}
	...
	public static void printStackTrace(int logLevel, String title, Throwable throwable) {
		...
		String date = formatter.format(Calendar.getInstance().getTime());
		WRITER.println(">> " + date + "; " + title + "; " + "Thr:" + Thread.currentThread().getName() + "; " + "LogLvl:" + LOG_LEVEL_CODES[logLevel] + "; " + getWhere() + "; ");
