...
<body>
    <kisso:hasPermission name="role_delete">
	...
	<div id="toolbar" style="padding: 1px; height: auto">
		<div style="margin-bottom: 1px;" id="${namespace }SearchDiv"
			...
			<form action="#" name="searchForm" id="searchForm"
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%"
					...
					<tr>
						...
						<td>
						<input style="width: 120px" name="nameLike"  class="easyui-validatebox" data-options="required:false,validType:['length[0,20]']"/>
						</td>
			...
			<kisso:hasPermission name="role_add">
				<a href="javascript:void(0);" onclick="add('role/toAdd','添加',400,420);" class="easyui-linkbutton" iconCls="icon-add" plain="true" title="添加">添加</a>
			</kisso:hasPermission>
			<kisso:hasPermission name="role_update">
				<a href="javascript:void(0);" onclick="update('role/toUpdate','修改',400,420);" class="easyui-linkbutton" iconCls="icon-edit" plain="true" title="修改">修改</a>
			</kisso:hasPermission>
			<kisso:hasPermission name="role_assign_resources">
		         <a href="javascript:void(0);" class="easyui-linkbutton" onclick="assignResources();" plain="true" title="分配访问资源">分配访问资源</a>
		    </kisso:hasPermission>
		</div>
	</div>
	
	<table class="easyui-datagrid" fit="true" <kisso:hasPermission name="role_find"> url="<c:url value="/role/find"> </c:url>" </kisso:hasPermission> id="${namespace }Grid"  title="数据列表" 
	     data-options="<kisso:hasPermission name="role_update">onDblClickCell: function(index,field,value){update('role/toUpdate','修改',400,420);}</kisso:hasPermission>" 
