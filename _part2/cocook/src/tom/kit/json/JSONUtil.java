...
import tom.kit.json.annotations.SMDMethod;
...
public class JSONUtil {
    ...
    public static void writeJSONToResponse(SerializationParams serializationParams) throws IOException {
        ...
        if (!isBlank(serializationParams.getSerializedJSON()))
            stringBuilder.append(serializationParams.getSerializedJSON());

        if (!isBlank(serializationParams.getWrapPrefix()))
        ...
        if (!isBlank(serializationParams.getWrapSuffix()))
